...
GTK_CFLAGS = -DG_DISABLE_SINGLE_INCLUDES -DG_DISABLE_DEPRECATED -DGDK_DISABLE_DEPRECATED -DGDK_DISABLE_DEPRECATION_WARNINGS -DGTK_DISABLE_SINGLE_INCLUDES -DGSEAL_ENABLE -D_REENTRANT -isystem/opt/local/include/gtk-3.0 -isystem/opt/local/include/at-spi2-atk/2.0 -isystem/opt/local/include/at-spi-2.0 -isystem/opt/local/include/dbus-1.0 -isystem/opt/local/lib/dbus-1.0/include -isystem/opt/local/include/gtk-3.0 -isystem/opt/local/include/gio-unix-2.0/ -isystem/opt/local/include -isystem/opt/local/include/cairo -isystem/opt/local/include -isystem/opt/local/include/pango-1.0 -isystem/opt/local/include/harfbuzz -isystem/opt/local/include -isystem/opt/local/include/pango-1.0 -isystem/opt/local/include/atk-1.0 -isystem/opt/local/include/cairo -isystem/opt/local/include/pixman-1 -isystem/opt/local/include -isystem/opt/local/include/freetype2 -isystem/opt/local/include -isystem/opt/local/include/freetype2 -isystem/opt/local/include/libpng16 -isystem/opt/local/include -isystem/opt/local/include/gdk-pixbuf-2.0 -isystem/opt/local/include/libpng16 -isystem/opt/local/include/glib-2.0 -isystem/opt/local/lib/glib-2.0/include -isystem/opt/local/include
GTK_LIBS = -L/opt/local/lib -lgtk-3 -lgdk-3 -lpangocairo-1.0 -lpango-1.0 -latk-1.0 -lcairo-gobject -lcairo -lgdk_pixbuf-2.0 -lgio-2.0 -lgobject-2.0 -lgthread-2.0 -lgmodule-2.0 -lglib-2.0 -lintl
GUI_CONFIGURE_FLAGS =  --with-gtk=3
HAVE_BLESS = yes
HAVE_CXX11 = 1
HAVE_DOXYGEN = yes
...
OBJDUMP = objdump
OBJEXT = o
OSX_APP_FLAGS = -sdkroot /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.12.sdk -gtk
OSX_DMG_FLAGS = -gtk
...
RCC = 
RPMBUILD = false
RPMBUILD_WITH_ARGS = --with gtk3 --without gtk2 --without qt --without qt5 --with lua
RPM_VERSION = 2.2.4
SBC_CFLAGS = 
SBC_LIBS = 
