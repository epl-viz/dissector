...
# plugins/epl/Makefile.  Generated from Makefile.in by configure.
...
target_triplet = x86_64-apple-darwin16.3.0
subdir = plugins/epl+xdd
...
epl_la_LIBADD =
am__objects_1 = epl_la-packet-epl.lo
am__objects_2 = $(am__objects_1)
am__objects_3 = $(am__objects_2)
am__objects_4 =
am__objects_5 = $(am__objects_4)
am_epl_la_OBJECTS = epl_la-plugin.lo $(am__objects_3) $(am__objects_5)
epl_la_OBJECTS = $(am_epl_la_OBJECTS)
AM_V_lt = $(am__v_lt_$(V))
am__v_lt_ = $(am__v_lt_$(AM_DEFAULT_VERBOSITY))
am__v_lt_0 = --silent
am__v_lt_1 = 
epl_la_LINK = $(LIBTOOL) $(AM_V_lt) --tag=CC $(AM_LIBTOOLFLAGS) \
	$(LIBTOOLFLAGS) --mode=link $(CCLD) $(epl_la_CFLAGS) $(CFLAGS) \
	$(epl_la_LDFLAGS) $(LDFLAGS) -o $@
AM_V_P = $(am__v_P_$(V))
...
am__v_CCLD_1 = 
SOURCES = $(epl_la_SOURCES)
DIST_SOURCES = $(epl_la_SOURCES)
...
A2X = a2x
A2X_LYNX = 
ACLOCAL = ${SHELL} /Users/a3f/dl/wireshark/missing aclocal-1.15
AC_MIN_VERSION = 2.64
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
APPLICATIONSERVICES_FRAMEWORKS = -framework ApplicationServices
AR = ar
AUTOCONF = ${SHELL} /Users/a3f/dl/wireshark/missing autoconf
AUTOHEADER = ${SHELL} /Users/a3f/dl/wireshark/missing autoheader
AUTOMAKE = ${SHELL} /Users/a3f/dl/wireshark/missing automake-1.15
AWK = gawk
BUILD_EXEEXT = 
BUILD_OBJEXT = 
CC = clang
...
CONFIG_ARGS = --with-lua=no --with-c-ares=/usr/local/Cellar/c-ares/1.12.0
...
FOP = fop
GEOIP_LIBS = -lGeoIP
GLIB_CFLAGS = -DG_DISABLE_SINGLE_INCLUDES -DG_DISABLE_DEPRECATED -D_REENTRANT -isystem/opt/local/include/glib-2.0 -isystem/opt/local/lib/glib-2.0/include -isystem/opt/local/include
GLIB_LIBS = -L/opt/local/lib -lgthread-2.0 -lgmodule-2.0 -lglib-2.0 -lintl
...
KRB5_CFLAGS = -I/opt/local/include
KRB5_CONFIG = /opt/local/bin/krb5-config
KRB5_LIBS = -L/opt/local/lib -dynamic -lkrb5 -lk5crypto -lcom_err
...
LIBCAP_LIBS = 
LIBGCRYPT_CFLAGS = -I/opt/local/include
LIBGCRYPT_CONFIG = /opt/local/bin/libgcrypt-config
LIBGCRYPT_LIBS = -L/opt/local/lib -lgcrypt -lgpg-error
LIBGNUTLS_CFLAGS = -I/opt/local/include -I/opt/local/include/p11-kit-1 -I/opt/local/include
LIBGNUTLS_LIBS = -L/opt/local/lib -lgnutls
LIBNL_CFLAGS = 
LIBNL_LIBS = 
...
LUA_LIBS = 
LZ4_LIBS = -llz4
MAKEINFO = ${SHELL} /Users/a3f/dl/wireshark/missing makeinfo
MANIFEST_TOOL = :
...
PLUGIN_LIBS = 
POD2HTML = /opt/local/bin/pod2html
...
RPMBUILD = false
RPMBUILD_WITH_ARGS = --without gtk2 --without gtk3 --with qt5 --without lua
RPM_VERSION = 2.3.0
SBC_CFLAGS = 
SBC_LIBS = 
...
WS_LDFLAGS = -Wl,-headerpad_max_install_names -Wl,-search_paths_first -mmacosx-version-min=10.12 -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.12.sdk  -L/usr/local/Cellar/c-ares/1.12.0/lib
XSLTPROC = xsltproc
YACC = bison -y
YFLAGS = 
abs_builddir = /Users/a3f/dl/wireshark/plugins/epl
abs_srcdir = /Users/a3f/dl/wireshark/plugins/epl
abs_top_builddir = /Users/a3f/dl/wireshark
abs_top_srcdir = /Users/a3f/dl/wireshark
ac_ct_AR = ar
ac_ct_CC = clang
...
install_sh = ${SHELL} /Users/a3f/dl/wireshark/install-sh
...
epl_la_CPPFLAGS = $(AM_CPPFLAGS) $(PLUGIN_CPPFLAGS)
epl_la_CFLAGS = $(AM_CFLAGS) $(PLUGIN_CFLAGS)
epl_la_LDFLAGS = $(PLUGIN_LDFLAGS)
CLEANFILES = \
	epl \
	*~
...
$(srcdir)/Makefile.in:  $(srcdir)/Makefile.am $(top_srcdir)/Makefile.am.inc $(srcdir)/../Makefile.am.inc $(am__configure_deps)
	...
	echo ' cd $(top_srcdir) && $(AUTOMAKE) --gnu plugins/epl/Makefile'; \
	$(am__cd) $(top_srcdir) && \
	  $(AUTOMAKE) --gnu plugins/epl/Makefile
...
epl.la: $(epl_la_OBJECTS) $(epl_la_DEPENDENCIES) $(EXTRA_epl_la_DEPENDENCIES) 
	$(AM_V_CCLD)$(epl_la_LINK) -rpath $(plugindir) $(epl_la_OBJECTS) $(epl_la_LIBADD) $(LIBS)
...
include ./$(DEPDIR)/epl_la-packet-epl.Plo
include ./$(DEPDIR)/epl_la-plugin.Plo
...
epl_la-plugin.lo: plugin.c
	$(AM_V_CC)$(LIBTOOL) $(AM_V_lt) --tag=CC $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(epl_la_CPPFLAGS) $(CPPFLAGS) $(epl_la_CFLAGS) $(CFLAGS) -MT epl_la-plugin.lo -MD -MP -MF $(DEPDIR)/epl_la-plugin.Tpo -c -o epl_la-plugin.lo `test -f 'plugin.c' || echo '$(srcdir)/'`plugin.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/epl_la-plugin.Tpo $(DEPDIR)/epl_la-plugin.Plo
#	$(AM_V_CC)source='plugin.c' object='epl_la-plugin.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(LIBTOOL) $(AM_V_lt) --tag=CC $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(epl_la_CPPFLAGS) $(CPPFLAGS) $(epl_la_CFLAGS) $(CFLAGS) -c -o epl_la-plugin.lo `test -f 'plugin.c' || echo '$(srcdir)/'`plugin.c

epl_la-packet-epl.lo: packet-epl.c
	$(AM_V_CC)$(LIBTOOL) $(AM_V_lt) --tag=CC $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(epl_la_CPPFLAGS) $(CPPFLAGS) $(epl_la_CFLAGS) $(CFLAGS) -MT epl_la-packet-epl.lo -MD -MP -MF $(DEPDIR)/epl_la-packet-epl.Tpo -c -o epl_la-packet-epl.lo `test -f 'packet-epl.c' || echo '$(srcdir)/'`packet-epl.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/epl_la-packet-epl.Tpo $(DEPDIR)/epl_la-packet-epl.Plo
#	$(AM_V_CC)source='packet-epl.c' object='epl_la-packet-epl.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(LIBTOOL) $(AM_V_lt) --tag=CC $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(epl_la_CPPFLAGS) $(CPPFLAGS) $(epl_la_CFLAGS) $(CFLAGS) -c -o epl_la-packet-epl.lo `test -f 'packet-epl.c' || echo '$(srcdir)/'`packet-epl.c
