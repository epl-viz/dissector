...
# plugins/epl_plus_xdd/Makefile.  Generated from Makefile.in by configure.
...
target_triplet = x86_64-apple-darwin16.4.0
subdir = plugins/epl_plus_xdd
...
epl_plus_xdd_la_LIBADD =
am__objects_1 = epl_plus_xdd_la-packet-epl.lo
am__objects_2 = $(am__objects_1)
am__objects_3 = $(am__objects_2)
am__objects_4 =
am__objects_5 = $(am__objects_4)
am_epl_plus_xdd_la_OBJECTS = epl_plus_xdd_la-plugin.lo \
	$(am__objects_3) $(am__objects_5)
epl_plus_xdd_la_OBJECTS = $(am_epl_plus_xdd_la_OBJECTS)
AM_V_lt = $(am__v_lt_$(V))
am__v_lt_ = $(am__v_lt_$(AM_DEFAULT_VERBOSITY))
am__v_lt_0 = --silent
am__v_lt_1 = 
epl_plus_xdd_la_LINK = $(LIBTOOL) $(AM_V_lt) --tag=CC \
	$(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=link $(CCLD) \
	$(epl_plus_xdd_la_CFLAGS) $(CFLAGS) $(epl_plus_xdd_la_LDFLAGS) \
	$(LDFLAGS) -o $@
AM_V_P = $(am__v_P_$(V))
...
am__v_CCLD_1 = 
SOURCES = $(epl_plus_xdd_la_SOURCES)
DIST_SOURCES = $(epl_plus_xdd_la_SOURCES)
...
am__DIST_COMMON = $(srcdir)/../Makefile.am.inc $(srcdir)/Makefile.in \
	$(top_srcdir)/Makefile.am.inc $(top_srcdir)/depcomp COPYING
DISTFILES = $(DIST_COMMON) $(DIST_SOURCES) $(TEXINFOS) $(EXTRA_DIST)
A2X = a2x
A2X_LYNX = 
ACLOCAL = ${SHELL} /Users/a3f/pse/wireshark/missing aclocal-1.15
AC_MIN_VERSION = 2.64
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
APPLICATIONSERVICES_FRAMEWORKS = -framework ApplicationServices
AR = ar
AUTOCONF = ${SHELL} /Users/a3f/pse/wireshark/missing autoconf
AUTOHEADER = ${SHELL} /Users/a3f/pse/wireshark/missing autoheader
AUTOMAKE = ${SHELL} /Users/a3f/pse/wireshark/missing automake-1.15
AWK = gawk
BUILD_EXEEXT = 
BUILD_OBJEXT = 
CC = clang
...
DEFS = -DHAVE_CONFIG_H
DEPDIR = .deps
DESKTOP_FILE_INSTALL = /opt/local/bin/desktop-file-install
DLLTOOL = false
...
FOP = fop
GEOIP_LIBS = -lGeoIP
GLIB_CFLAGS = -DG_DISABLE_SINGLE_INCLUDES -DG_DISABLE_DEPRECATED -D_REENTRANT -isystem/usr/local/Cellar/glib/2.50.2/include/glib-2.0 -isystem/usr/local/Cellar/glib/2.50.2/lib/glib-2.0/include -isystem/usr/local/opt/gettext/include -isystem/usr/local/Cellar/pcre/8.39/include
GLIB_LIBS = -L/usr/local/Cellar/glib/2.50.2/lib -L/usr/local/opt/gettext/lib -lgthread-2.0 -lgmodule-2.0 -lglib-2.0 -lintl
GLIB_MIN_VERSION = 2.16.0
GREP = /usr/bin/grep
GTK2_MIN_VERSION = 2.12.0
GTK3_MIN_VERSION = 3.0.0
GTK_CFLAGS = -DG_DISABLE_SINGLE_INCLUDES -DG_DISABLE_DEPRECATED -DGDK_DISABLE_DEPRECATED -DGDK_DISABLE_DEPRECATION_WARNINGS -DGTK_DISABLE_SINGLE_INCLUDES -DGSEAL_ENABLE -D_REENTRANT -isystem/usr/local/Cellar/gtk+3/3.22.5/include/gtk-3.0 -isystem/usr/local/Cellar/glib/2.50.2/include/gio-unix-2.0/ -isystem/usr/local/Cellar/cairo/1.14.8/include/cairo -isystem/usr/local/Cellar/libepoxy/1.3.1/include -isystem/usr/local/Cellar/pango/1.40.3/include/pango-1.0 -isystem/usr/local/Cellar/harfbuzz/1.3.4_1/include/harfbuzz -isystem/usr/local/Cellar/pango/1.40.3/include/pango-1.0 -isystem/usr/local/Cellar/atk/2.22.0/include/atk-1.0 -isystem/usr/local/Cellar/cairo/1.14.8/include/cairo -isystem/usr/local/Cellar/pixman/0.34.0/include/pixman-1 -isystem/usr/local/Cellar/fontconfig/2.12.1_2/include -isystem/usr/local/opt/freetype/include/freetype2 -isystem/usr/local/Cellar/libpng/1.6.27/include/libpng16 -isystem/usr/local/Cellar/gdk-pixbuf/2.36.2/include/gdk-pixbuf-2.0 -isystem/usr/local/Cellar/libpng/1.6.27/include/libpng16 -isystem/usr/local/Cellar/glib/2.50.2/include/glib-2.0 -isystem/usr/local/Cellar/glib/2.50.2/lib/glib-2.0/include -isystem/usr/local/opt/gettext/include -isystem/usr/local/Cellar/pcre/8.39/include
GTK_LIBS = -L/usr/local/Cellar/gtk+3/3.22.5/lib -L/usr/local/Cellar/pango/1.40.3/lib -L/usr/local/Cellar/atk/2.22.0/lib -L/usr/local/Cellar/cairo/1.14.8/lib -L/usr/local/Cellar/gdk-pixbuf/2.36.2/lib -L/usr/local/Cellar/glib/2.50.2/lib -L/usr/local/opt/gettext/lib -lgtk-3 -lgdk-3 -lpangocairo-1.0 -lpango-1.0 -latk-1.0 -lcairo-gobject -lcairo -lgdk_pixbuf-2.0 -lgio-2.0 -lgobject-2.0 -lgthread-2.0 -lgmodule-2.0 -lglib-2.0 -lintl
GUI_CONFIGURE_FLAGS =  --with-qt --with-gtk=3
HAVE_BLESS = yes
HAVE_CXX11 = 1
HAVE_DOXYGEN = yes
...
LIBGNUTLS_CFLAGS = -I/usr/local/Cellar/gnutls/3.4.17_1/include -I/usr/local/Cellar/nettle/3.3/include -I/usr/local/Cellar/libtasn1/4.9/include -I/usr/local/Cellar/p11-kit/0.23.3/include/p11-kit-1
LIBGNUTLS_LIBS = -L/usr/local/Cellar/gnutls/3.4.17_1/lib -lgnutls
LIBNL_CFLAGS = 
LIBNL_LIBS = 
...
PACKAGE_STRING = Wireshark 2.2.4
...
Qt_CFLAGS =  -isystem/usr/local/Cellar/qt5/5.7.1_1/include/QtCore -isystem/usr/local/Cellar/qt5/5.7.1_1/include -isystem/usr/local/Cellar/qt5/5.7.1_1/include/QtGui -isystem/usr/local/Cellar/qt5/5.7.1_1/include -isystem/usr/local/Cellar/qt5/5.7.1_1/include/QtCore -isystem/usr/local/Cellar/qt5/5.7.1_1/include -isystem/usr/local/Cellar/qt5/5.7.1_1/include/QtWidgets -isystem/usr/local/Cellar/qt5/5.7.1_1/include -isystem/usr/local/Cellar/qt5/5.7.1_1/include/QtGui -isystem/usr/local/Cellar/qt5/5.7.1_1/include -isystem/usr/local/Cellar/qt5/5.7.1_1/include/QtCore -isystem/usr/local/Cellar/qt5/5.7.1_1/include -isystem/usr/local/Cellar/qt5/5.7.1_1/include/QtPrintSupport -isystem/usr/local/Cellar/qt5/5.7.1_1/include -isystem/usr/local/Cellar/qt5/5.7.1_1/include/QtWidgets -isystem/usr/local/Cellar/qt5/5.7.1_1/include -isystem/usr/local/Cellar/qt5/5.7.1_1/include/QtGui -isystem/usr/local/Cellar/qt5/5.7.1_1/include -isystem/usr/local/Cellar/qt5/5.7.1_1/include/QtCore -isystem/usr/local/Cellar/qt5/5.7.1_1/include -isystem/usr/local/Cellar/qt5/5.7.1_1/include/QtMultimedia -isystem/usr/local/Cellar/qt5/5.7.1_1/include -isystem/usr/local/Cellar/qt5/5.7.1_1/include/QtNetwork -isystem/usr/local/Cellar/qt5/5.7.1_1/include -isystem/usr/local/Cellar/qt5/5.7.1_1/include/QtGui -isystem/usr/local/Cellar/qt5/5.7.1_1/include -isystem/usr/local/Cellar/qt5/5.7.1_1/include/QtCore -isystem/usr/local/Cellar/qt5/5.7.1_1/include -isystem/usr/local/Cellar/qt5/5.7.1_1/include/QtMacExtras -isystem/usr/local/Cellar/qt5/5.7.1_1/include -isystem/usr/local/Cellar/qt5/5.7.1_1/include/QtGui -isystem/usr/local/Cellar/qt5/5.7.1_1/include -isystem/usr/local/Cellar/qt5/5.7.1_1/include/QtCore -isystem/usr/local/Cellar/qt5/5.7.1_1/include
Qt_LDFLAGS = -Wl,-rpath,/usr/local/Cellar/qt5/5.7.1_1/lib
Qt_LIBS =  -F/usr/local/Cellar/qt5/5.7.1_1/lib -framework QtCore -F/usr/local/Cellar/qt5/5.7.1_1/lib -framework QtGui -F/usr/local/Cellar/qt5/5.7.1_1/lib -framework QtCore -F/usr/local/Cellar/qt5/5.7.1_1/lib -framework QtWidgets -F/usr/local/Cellar/qt5/5.7.1_1/lib -framework QtGui -F/usr/local/Cellar/qt5/5.7.1_1/lib -framework QtCore -F/usr/local/Cellar/qt5/5.7.1_1/lib -framework QtPrintSupport -F/usr/local/Cellar/qt5/5.7.1_1/lib -framework QtWidgets -F/usr/local/Cellar/qt5/5.7.1_1/lib -framework QtGui -F/usr/local/Cellar/qt5/5.7.1_1/lib -framework QtCore -F/usr/local/Cellar/qt5/5.7.1_1/lib -framework QtMultimedia -F/usr/local/Cellar/qt5/5.7.1_1/lib -framework QtNetwork -F/usr/local/Cellar/qt5/5.7.1_1/lib -framework QtGui -F/usr/local/Cellar/qt5/5.7.1_1/lib -framework QtCore -F/usr/local/Cellar/qt5/5.7.1_1/lib -framework QtMacExtras -F/usr/local/Cellar/qt5/5.7.1_1/lib -framework QtGui -F/usr/local/Cellar/qt5/5.7.1_1/lib -framework QtCore
RANLIB = ranlib
RCC = /usr/local/Cellar/qt5/5.7.1_1/bin//rcc
RPMBUILD = false
RPMBUILD_WITH_ARGS = --with gtk3 --without gtk2 --with qt5 --with lua
RPM_VERSION = 2.2.4
SBC_CFLAGS = 
SBC_LIBS = 
...
YACC = bison -y
YFLAGS = 
abs_builddir = /Users/a3f/pse/wireshark/plugins/epl_plus_xdd
abs_srcdir = /Users/a3f/pse/wireshark/plugins/epl_plus_xdd
abs_top_builddir = /Users/a3f/pse/wireshark
abs_top_srcdir = /Users/a3f/pse/wireshark
ac_ct_AR = ar
ac_ct_CC = clang
ac_ct_CC_FOR_BUILD = clang
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
am__include = include
am__leading_dot = .
...
install_sh = ${SHELL} /Users/a3f/pse/wireshark/install-sh
...
pdfdir = ${docdir}
plugindir = ${libdir}/wireshark/plugins/2.2.4
plugins_dir = plugins
prefix = /usr/local
...
plugin_LTLIBRARIES = epl_plus_xdd.la
epl_plus_xdd_la_SOURCES = \
	plugin.c \
	moduleinfo.h \
	$(SRC_FILES)	\
	$(HEADER_FILES)

epl_plus_xdd_la_CPPFLAGS = $(AM_CPPFLAGS) $(PLUGIN_CPPFLAGS)
epl_plus_xdd_la_CFLAGS = $(AM_CFLAGS) $(PLUGIN_CFLAGS)
epl_plus_xdd_la_LDFLAGS = $(PLUGIN_LDFLAGS)
CLEANFILES = \
	epl_plus_xdd \
	*~
...
$(srcdir)/Makefile.in:  $(srcdir)/Makefile.am $(top_srcdir)/Makefile.am.inc $(srcdir)/../Makefile.am.inc $(am__configure_deps)
	@for dep in $?; do \
	...
	echo ' cd $(top_srcdir) && $(AUTOMAKE) --gnu plugins/epl_plus_xdd/Makefile'; \
	$(am__cd) $(top_srcdir) && \
	  $(AUTOMAKE) --gnu plugins/epl_plus_xdd/Makefile
...
$(top_srcdir)/Makefile.am.inc $(srcdir)/../Makefile.am.inc $(am__empty):
...
epl_plus_xdd.la: $(epl_plus_xdd_la_OBJECTS) $(epl_plus_xdd_la_DEPENDENCIES) $(EXTRA_epl_plus_xdd_la_DEPENDENCIES) 
	$(AM_V_CCLD)$(epl_plus_xdd_la_LINK) -rpath $(plugindir) $(epl_plus_xdd_la_OBJECTS) $(epl_plus_xdd_la_LIBADD) $(LIBS)
...
include ./$(DEPDIR)/epl_plus_xdd_la-packet-epl.Plo
include ./$(DEPDIR)/epl_plus_xdd_la-plugin.Plo
...
epl_plus_xdd_la-plugin.lo: plugin.c
	$(AM_V_CC)$(LIBTOOL) $(AM_V_lt) --tag=CC $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(epl_plus_xdd_la_CPPFLAGS) $(CPPFLAGS) $(epl_plus_xdd_la_CFLAGS) $(CFLAGS) -MT epl_plus_xdd_la-plugin.lo -MD -MP -MF $(DEPDIR)/epl_plus_xdd_la-plugin.Tpo -c -o epl_plus_xdd_la-plugin.lo `test -f 'plugin.c' || echo '$(srcdir)/'`plugin.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/epl_plus_xdd_la-plugin.Tpo $(DEPDIR)/epl_plus_xdd_la-plugin.Plo
#	$(AM_V_CC)source='plugin.c' object='epl_plus_xdd_la-plugin.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(LIBTOOL) $(AM_V_lt) --tag=CC $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(epl_plus_xdd_la_CPPFLAGS) $(CPPFLAGS) $(epl_plus_xdd_la_CFLAGS) $(CFLAGS) -c -o epl_plus_xdd_la-plugin.lo `test -f 'plugin.c' || echo '$(srcdir)/'`plugin.c

epl_plus_xdd_la-packet-epl.lo: packet-epl.c
	$(AM_V_CC)$(LIBTOOL) $(AM_V_lt) --tag=CC $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(epl_plus_xdd_la_CPPFLAGS) $(CPPFLAGS) $(epl_plus_xdd_la_CFLAGS) $(CFLAGS) -MT epl_plus_xdd_la-packet-epl.lo -MD -MP -MF $(DEPDIR)/epl_plus_xdd_la-packet-epl.Tpo -c -o epl_plus_xdd_la-packet-epl.lo `test -f 'packet-epl.c' || echo '$(srcdir)/'`packet-epl.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/epl_plus_xdd_la-packet-epl.Tpo $(DEPDIR)/epl_plus_xdd_la-packet-epl.Plo
#	$(AM_V_CC)source='packet-epl.c' object='epl_plus_xdd_la-packet-epl.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(LIBTOOL) $(AM_V_lt) --tag=CC $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(epl_plus_xdd_la_CPPFLAGS) $(CPPFLAGS) $(epl_plus_xdd_la_CFLAGS) $(CFLAGS) -c -o epl_plus_xdd_la-packet-epl.lo `test -f 'packet-epl.c' || echo '$(srcdir)/'`packet-epl.c
